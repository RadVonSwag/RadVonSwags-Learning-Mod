...
public class RadsLearningBlocks {
    ...
    public static final Block LEMON_WOOD_SLAB = add("lemon_wood_slab", new SlabBlock(AbstractBlock.Settings.of(Material.WOOD, MapColor.PALE_YELLOW).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
